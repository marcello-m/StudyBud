...
<div class="row">
    ...
    <div class="col" style="margin-bottom: 8%;">
        <div class="card" style="padding: 5%;">
            <h1 style="color: #30475E;">Nome corso</h1>
            <!-- NEW POST -->
            ...
            <div class="card post-body">
                <div class="card-body">
                    ...
                    <p class="card-text" style="margin-top: 3%;">Un post scritto per il corso al quale è riferita questa pagina</p>
                    ...
                    <span style="font-weight: 500; margin-inline: 1%;">23</span>
                    <button class="btn btn-primary btn btn-lg login post-comment-btn" style="width: 22pt;">
